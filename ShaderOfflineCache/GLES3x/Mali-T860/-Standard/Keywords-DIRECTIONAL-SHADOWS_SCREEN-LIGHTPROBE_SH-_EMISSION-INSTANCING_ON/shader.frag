...
void main()
{
    ...
    u_xlat30.x = (-u_xlat17.x) + u_xlat30.x;
    u_xlat17.x = unity_ShadowFadeCenterAndType.w * u_xlat30.x + u_xlat17.x;
    ...
    u_xlat16_30 = texture(_ShadowMapTexture, u_xlat30.xy).x;
    u_xlat16_42 = (-u_xlat16_30) + unity_Builtins2Array[u_xlati4 / 7].unity_SHCArray.w;
    u_xlat16_42 = u_xlat17.x * u_xlat16_42 + u_xlat16_30;
    u_xlat16_17 = texture(_OcclusionMap, vs_TEXCOORD0.xy).y;
    u_xlat16_6.x = (-_OcclusionStrength) + 1.0;
    u_xlat16_6.x = u_xlat16_17 * _OcclusionStrength + u_xlat16_6.x;
    ...
    u_xlat16_4.xzw = log2(u_xlat16_8.xyz);
    ...
    u_xlat16_42 = (-u_xlat17.x) * 0.699999988 + 1.70000005;
    u_xlat16_42 = u_xlat16_42 * u_xlat17.x;
    ...
    u_xlat16_42 = u_xlat16_42 * u_xlat17.x + -0.5;
    ...
    u_xlat14.x = u_xlat17.x * u_xlat17.x;
    ...
    u_xlat39 = u_xlat14.x * u_xlat17.x;
    ...
    u_xlat16_21.xyz = u_xlat16_4.xzw * u_xlat16_6.xxx + u_xlat16_21.xyz;
