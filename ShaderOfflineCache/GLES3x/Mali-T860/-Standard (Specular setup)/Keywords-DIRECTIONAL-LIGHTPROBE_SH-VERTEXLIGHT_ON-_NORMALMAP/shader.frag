...
void main()
{
    ...
    u_xlat16_0 = dot(u_xlat16_7.xyz, _WorldSpaceLightPos0.xyz);
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_5.xyz = vec3(u_xlat16_19) * u_xlat16_6.xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * u_xlat16_5.xyz + u_xlat16_3.xyz;
    u_xlat16_4.xyz = u_xlat0.xxx * _SpecColor.xyz + u_xlat16_5.xyz;
