...
void main()
{
    ...
    u_xlat16_7.xyz = u_xlat16_8.xxx * u_xlat16_7.xyz + _SpecColor.xyz;
    u_xlat16_3.xyz = u_xlat16_3.xyz * u_xlat16_7.xyz;
    u_xlat16_8.xyz = texture(_MainTex, vs_TEXCOORD0.xy).xyz;
    u_xlat16_8.xyz = u_xlat16_8.xyz * _Color.xyz;
    u_xlat16_7.xyz = vec3(u_xlat16_27) * u_xlat16_8.xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * u_xlat16_7.xyz + u_xlat16_3.xyz;
    u_xlat16_4.xyz = u_xlat0.xxx * _SpecColor.xyz + u_xlat16_7.xyz;
